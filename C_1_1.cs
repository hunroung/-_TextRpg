...
{
    public partial class C_1_1 : Form
    {
        public C_1_1()
        {
            InitializeComponent();
        ...
        {
            move_btn_enable();
            textBox1.Text += "길을 걷던 당신은 야생의 슬라임을 밟았다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "작고 푸른빛이 나는 몸을 한 그것은 그리 위협적으로 보이진 않는다.\r\n";
        ...
        private void C_1_1_Shown(object sender, EventArgs e)
        {
