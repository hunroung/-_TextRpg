...
{
    public partial class C_2_3 : Form
    {
        public C_2_3()
        {
            InitializeComponent();
        ...
        {
            move_btn_enable();
            textBox1.Text += "갑작스레 호수의 표면이 출렁인다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "오색의 빛을 내뿜는 등껍질이 물 위로 떠오른다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "작은 눈을 부라리는 거북의 머리도 물 위로 떠오른다.\r\n";
        ...
        public C_2_3(ref character character)
        {
        ...
        private void C_2_3_Load_1(object sender, EventArgs e)
        {
