...
{
    public partial class C_2_3_1 : Form
    {
        public C_2_3_1()
        {
            InitializeComponent();
        ...
        public C_2_3_1(ref character character)
        {
            ch = character;
            InitializeComponent();
            setting(character);
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@전투 시스템@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        private void C_2_3_1_Load(object sender, EventArgs e)
        {
            move_btn_enable(); //필수

            //@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("당신은 붉은 호수를 지나가고 있다. \r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
        ...
        {
            C_2_3_2 form = new C_2_3_2(ref ch);
            this.Hide();
            form.ShowDialog();
