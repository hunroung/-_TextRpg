...
namespace WindowsFormsApp1
{
    public partial class C_3_3 : Form
    {
        ...
        {
            move_btn_enable();
            textBox1.Text += "계단이 끝나고 당신은 긴 복도에 발을 들인다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "멀어 보이는 복도의 반대편에 거대한 문이 보인다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "그 앞에는 문을 지키듯이 기사가 서있다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "투구의 틈으로 보이는 두 눈이 당신을 노려본다.\r\n";
