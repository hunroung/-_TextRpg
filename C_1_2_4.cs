...
namespace WindowsFormsApp1
{
    public partial class C_1_2_4 : Form
    {
        ...
        private void C_1_2_4_Load(object sender, EventArgs e)
        {
            ...
            //@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@
            textBox1.Text += "결계를 넘어서 숲의 깊은 곳으로 들어왔다. \r\n";
            this.Refresh();
            Thread.Sleep(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
            textBox1.Text += "당신은 주변에서 강한 화염 마나의 움직임을 느낄 수 있었다. \r\n";
            this.Refresh();
            Thread.Sleep(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
        ...
        private void C_1_2_4_Load_1(object sender, EventArgs e)
        {
