...
{
    public partial class C_1_2_1 : Form
    {
        public C_1_2_1()
        {
            InitializeComponent();
        ...
        public C_1_2_1(ref character character)
        {
            ch = character;
            InitializeComponent();
            setting(character);
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@전투 시스템@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        private void C_1_2_1_Load(object sender, EventArgs e)
        {
            move_btn_enable(); //필수

            //@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@
            textBox1.Text += "당신은 마법사의 숲으로 들어왔다. \r\n";
            this.Refresh();
            Thread.Sleep(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
            textBox1.Text += "당신은 주변에서 마나의 움직임을 느낄 수 있었다. \r\n";
            this.Refresh();
            Thread.Sleep(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
            textBox1.Text += "하지만 마나의 움직임에서는 당신을 향한 적의가 가득 차 있었다. \r\n";
            this.Refresh();
            Thread.Sleep(2000);
            //@@@@@@@@@@@@@@@@@@@@몬스터 등장@@@@@@@@@@@@@@@@@@
            ...
            textBox1.Text += "당신의 앞에 지팡이를 든 " + npc_name.Text + " (이)가 나왔다! \r\n";
            //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        private void btn_attack_Click(object sender, EventArgs e)
        {
            ...
            if (k == 1)
            {
                ...
                else
                {
                    ...
                    ch.item_gain(0, 1);//변경 필요
                    textBox1.Text += npc_name.Text + "이 죽었다. exp : " + monster.exp.ToString() + " 획득, 회복 포션 1개 획득\r\n";//변경 필요
        ...
        {
            C_1_2_2 form = new C_1_2_2(ref ch);
            this.Hide();
            form.ShowDialog();
