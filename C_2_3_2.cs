...
{
    public partial class C_2_3_2 : Form
    {
        public C_2_3_2()
        {
            InitializeComponent();
        ...
        public C_2_3_2(ref character character)
        {
            ch = character;
            InitializeComponent();
            setting(character);
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@전투 시스템@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        private void C_2_3_2_Load(object sender, EventArgs e)
        {
            move_btn_enable(); //필수

            //@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("당신은 붉은 호수의 끝에 다다랐다. \r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("당신은 귓가에서 윙윙거리는 불쾌한 소리가 들리는 걸 느꼈다. \r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@몬스터 등장@@@@@@@@@@@@@@@@@@
            monster = new big_mosquito();
            fight = 1;
            setting(ch);
            picture_npc.Image = monster.img;
            textBox1.AppendText("그러자 붉은 호수에서 " + npc_name.Text + " (이)가 나왔다! \r\n");
            //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        private void C_2_3_2_Load_1(object sender, EventArgs e)
        {
