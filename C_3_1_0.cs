...
{
    public partial class C_3_1_0 : Form
    {
        public C_3_1_0()
        {
            InitializeComponent();
        ...
        public C_3_1_0(ref character character)
        {
            ch = character;
            InitializeComponent();
            setting(character);
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@전투 시스템@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        private void C_3_1_0_Load(object sender, EventArgs e)
        {
            move_btn_enable(); //필수

            //@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("당신은 사원 옆에 마련된 작은 정원에 들어왔다.\r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
            ...
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("하지만 그것도 잠시 누군가가 당신에게 다가오는 기척을 느꼈다.\r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@몬스터 등장@@@@@@@@@@@@@@@@@@
            monster = new green_nepen();
            fight = 1;
            setting(ch);
        ...
        {
            C_3_1_1 form = new C_3_1_1(ref ch);
            this.Hide();
            form.ShowDialog();
