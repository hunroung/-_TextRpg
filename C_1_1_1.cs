...
namespace WindowsFormsApp1
{
    public partial class C_1_1_1 : Form
    {
        ...
        {
            move_btn_enable();
            textBox1.AppendText("당신은 더 깊은 바다를 항해하기 위해 배를 탔다.\r\n");
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.AppendText("그렇게 좋던 햇살 아래 갑자기 그림자가 드리운다.\r\n");
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.AppendText("위를 보니 엄청난 고래가 물 위로 점프하여 해를 가리고 있다!\r\n");
            this.Refresh();
            Thread.Sleep(2000);
        ...
        private void C_1_1_1_Load_1(object sender, EventArgs e)
        {
