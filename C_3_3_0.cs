...
{
    public partial class C_3_3_0 : Form
    {
        public C_3_3_0()
        {
            InitializeComponent();
        ...
        private void C_3_3_0_Load(object sender, EventArgs e)
        {
        ...
        public C_3_3_0(ref character character)
        {
            ch = character;
            InitializeComponent();
            setting(character);
        ...
        private void _1_test_Load(object sender, EventArgs e)
        {
            ...
            //@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("당신은 사원을 걸어다니던 중 사람들이 모여있는 곳을 발견했다. \r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("그러나 사람들은 이미 정신이 나가있는 상태였다. \r\n");
            this.Refresh();
            Delay(2000);
            textBox1.AppendText("이런! 소리를 너무 크게 내어 누군가가 당신에게 다가온다. \r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@몬스터 등장@@@@@@@@@@@@@@@@@@
            monster = new Blinder();
            monster.name = "앞이 보이지 않는자";
            fight = 1;
            setting(ch);
            picture_npc.Image = monster.img;
            textBox1.AppendText("앞이 보이지 않는자 (이)가 나타났다! \r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        {
            C_3_3_1 form = new C_3_3_1(ref ch);
            this.Hide();
            form.ShowDialog();
