...
namespace WindowsFormsApp1
{
    public partial class C_1_1_0 : Form
    {
        ...
        {
            move_btn_enable();
            textBox1.Text += "당신은 바다마을에 입성했다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "바닷가를 떠돌던 중 저 멀리 낯선 지느러미가 보인다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "가만히 보던 중 그 지느러미가 점점 나에게 빠르게 다가온다!\r\n";
            this.Refresh();
            Thread.Sleep(2000);
        ...
        private void C_1_1_0_Load_1(object sender, EventArgs e)
        {
