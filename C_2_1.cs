...
{
    public partial class C_2_1 : Form
    {
        public C_2_1()
        {
            InitializeComponent();
        }
        private void C_2_1_Load(object sender, EventArgs e)
        {
            move_btn_enable();
            textBox1.Text += "삐걱이는 나무다리를 건너는 당신의 앞에 무언가 안개 속에서 나타났다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "안개와 같은 날개를 지닌 요정은 어쩐지 당신의 앞길을 막고 싶은듯 하다.\r\n";
        ...
        public C_2_1(ref character character)
        {
        ...
        {
            /*
            C_2_1_0 form = new C_2_1_0(ref ch);
            this.Hide();
            form.ShowDialog();
