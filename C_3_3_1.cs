...
{
    public partial class C_3_3_1 : Form
    {
        public C_3_3_1()
        {
            InitializeComponent();
        ...
        private void C_3_3_1_Load(object sender, EventArgs e)
        {
        ...
        public C_3_3_1(ref character character)
        {
            ch = character;
            InitializeComponent();
            setting(character);
        ...
        {
            if(ch.skill_have("108번뇌")!=-1)
            {
                MessageBox.Show("당신은 이미 왕초를 쓰러트렸습니다.");
                this.Close();
            }
            else
            {
                ...
                //@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@
                monster = new Poor_king();
                monster.name = "왕초";
                fight = 1;
                setting(ch);
                picture_npc.Image = monster.img;
                textBox1.AppendText("당신은 인파를 해치고 들어가자 거지로 보이는 사람들 사이에 왕과 맞주쳤다. \r\n");
                this.Refresh();
                Delay(2000);
                //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
                textBox1.AppendText("그는 당신과 대결을 하길 원했다. \r\n");
                this.Refresh();
                Delay(2000);
                textBox1.AppendText("왕초: 나와 싸운다면 내 기술을 하나 전수해 주도록하지 \r\n");
                this.Refresh();
                Delay(2000);
                if(MessageBox.Show("왕초와 싸우시겠습니까? \n 주의 - 준 보스 입니다.","왕초와의 전투",MessageBoxButtons.YesNo)==DialogResult.Yes)
                {
                    ch.skill_gain("108번뇌");
                    setting(ch);
                    textBox1.AppendText("왕초: 껄껄 훌륭한 자세다. \r\n");
                    this.Refresh();
                    Delay(2000);
                
                    textBox1.AppendText("왕초 와 대결하게 되었다! \r\n");
                    this.Refresh();
                    Delay(2000);
                    //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                ...
                {
                    textBox1.AppendText("왕초: 이잇 재미없는 녀석 썩 나가버려! \r\n");
                    this.Refresh();
                    Delay(2000);
                    this.Close();
                }
        ...
        private void btn_attack_Click(object sender, EventArgs e)
        {
            ...
            if (k == 1)
            {
                ...
                else
                {
                    ...
                    textBox1.AppendText(npc_name.Text + "이 쓰러졌다. exp : " + monster.exp.ToString() + " 획득, 회복 포션 3개 획득\r\n");//변경 필요
