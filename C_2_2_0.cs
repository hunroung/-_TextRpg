...
{
    public partial class C_2_2_0 : Form
    {
        public C_2_2_0()
        {
            InitializeComponent();
        ...
        public C_2_2_0(ref character character)
        {
        ...
        private void btn_down_move_Click(object sender, EventArgs e)
        {
            ...
            if (ch.tur_visit == 0)
            {
                textBox1.AppendText("나무들이 길을 막고 있다. \r\n지나갈 수 없어 보인다.\r\n\r\n");
            }
            else
            {
                C_2_2_1 form = new C_2_2_1(ref ch);
                this.Hide();
                form.ShowDialog();
        ...
        private void C_2_2_0_Load(object sender, EventArgs e)
        {
            if (ch.tur_visit == 0)
            {
                picture_npc.Image = Image.FromFile(".\\img\\tree1.png");
                move_btn_enable();
                textBox1.AppendText("호수 주변은 나무들로 둘러싸여 있다.\r\n");
                move_btn_able();
            }
            else
            {
                picture_npc.Image = Image.FromFile(".\\img\\tree2.png");
