...
{
    public partial class C_2_3_0 : Form
    {
        public C_2_3_0()
        {
            InitializeComponent();
        ...
        public C_2_3_0(ref character character)
        {
            ch = character;
            InitializeComponent();
            setting(character);
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@전투 시스템@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        private void C_2_3_0_Load(object sender, EventArgs e)
        {
            move_btn_enable(); //필수

            //@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("당신은 호수의 깊은 곳으로 들어왔다. \r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("호수의 깊은 곳으로 갈수록 호수의 색깔이 붉어졌다.\r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@몬스터 등장@@@@@@@@@@@@@@@@@@
            monster = new piranha();
        ...
        {
            C_2_3_1 form = new C_2_3_1(ref ch);
            this.Hide();
            form.ShowDialog();
