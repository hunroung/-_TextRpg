...
{
    public partial class C_3_1_2 : Form
    {
        public C_3_1_2()
        {
            InitializeComponent();
        ...
        public C_3_1_2(ref character character)
        {
            ch = character;
            InitializeComponent();
            setting(character);
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@전투 시스템@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        private void C_3_1_2_Load(object sender, EventArgs e)
        {
            move_btn_enable(); //필수

            //@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("당신은 정원의 끝자락에 다다랐다.\r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("그곳에는 형형색색의 식물이 가득했다.\r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("하지만 그것도 잠시 당신에게 다가오는 뜨거운 불길을 느꼈다.\r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@몬스터 등장@@@@@@@@@@@@@@@@@@
            monster = new red_nepen();
            fight = 1;
            setting(ch);
            picture_npc.Image = monster.img;
            textBox1.AppendText("그러자 정원의 풀숲 사이에서 " + npc_name.Text + " (이)가 나왔다! \r\n");
            //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        private void C_3_1_2_Load_1(object sender, EventArgs e)
        {
