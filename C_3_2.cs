...
{
    public partial class C_3_2 : Form
    {
        public C_3_2()
        {
            InitializeComponent();
        ...
        {
            move_btn_enable();
            textBox1.Text += "지하로 내려가는 계단에서 어쩐지 당신은 위화감을 느낀다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "당신은 위화감이 느껴지는 방향을 가만히 응시한다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "그러자 대리석 기둥 뒤에서 양손에 단검을 든 사람이 걸어나온다.\r\n";
        ...
        public C_3_2(ref character character)
        {
        ...
        {
            /*
            C_3_2_0 form = new C_3_2_0(ref ch);
            this.Hide();
            form.ShowDialog();
