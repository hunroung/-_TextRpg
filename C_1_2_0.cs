    ...
    public partial class C_1_2_0 : Form
    {
        ...
        private void C_1_2_0_Load(object sender, EventArgs e)
        {
            if(ch.secret_shop01 == 0)
            {
                ...
                textBox1.Text += "던전을 탐색하던 도중 자욱한 연기 사이에서 비밀 상점이 나타났다. \r\n";
                this.Refresh();
                Thread.Sleep(2000);
                textBox1.Text += "한 번 둘러볼까? \r\n\r\n";
                this.Refresh();
                Thread.Sleep(2000);
        ...
        private void btn_yes_Click(object sender, EventArgs e)
        {
            ...
            textBox1.Text += "비밀 상점에서는 던전을 탐험하는데 도움이 되는 아이템들이 많았다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "소지하고 있는 코인으로 다양한 아이템을 구매할 수 있어 보인다.\r\n\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            ...
            textBox1.Text += "[비밀 상점 아이템 목록]\r\n";
            textBox1.Text += "① 회복물약 3개 - 체력을 10 회복합니다. [ 구매가격 : 코인 1개 ]\r\n\r\n";
            textBox1.Text += "② 대형회복물약 1개 - 체력을 30 회복합니다. 스킬사용횟수가 1회 추가됩니다. [ 구매가격 : 코인 1개 ]\r\n\r\n";
            textBox1.Text += "③ 스킬회복물약 1개 - 스킬사용횟수가 3회 추가됩니다. [ 구매가격 : 코인 1개 ] \r\n\r\n";
        ...
        {
            textBox1.Text += "비밀 상점을 뒤로한 채 당신은 던전을 탐험하기로 결정했다. \r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "곧이어, 비밀 상점은 자욱한 연기에 가려져 흔적도 없이 사라졌다. \r\n";
            this.Refresh();
            Thread.Sleep(2000);
            btn_yes.Visible = false;
            btn_no.Visible = false;
        ...
        {
            textBox1.Text += "비밀 상점에서 나온 당신은 다시 던전을 탐험하기로 결정했다. \r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "곧이어, 비밀 상점은 자욱한 연기에 가려져 흔적도 없이 사라졌다. \r\n";
            this.Refresh();
