...
{
    public partial class C_3_1_1 : Form
    {
        public C_3_1_1()
        {
            InitializeComponent();
        ...
        public C_3_1_1(ref character character)
        {
            ch = character;
            InitializeComponent();
            setting(character);
        ...
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@전투 시스템@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        private void C_3_1_1_Load(object sender, EventArgs e)
        {
            move_btn_enable(); //필수

            //@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("당신은 정원을 좀더 깊게 들어갔다.\r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
            ...
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("하지만 그것도 잠시 누군가가 당신에게 다가오는 차가운 기척을 느꼈다.\r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@몬스터 등장@@@@@@@@@@@@@@@@@@
            monster = new blue_nepen();
            fight = 1;
            setting(ch);
        ...
        {
            C_3_1_2 form = new C_3_1_2(ref ch);
            this.Hide();
            form.ShowDialog();
