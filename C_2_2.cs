...
{
    public partial class C_2_2 : Form
    {
        public C_2_2()
        {
            InitializeComponent();
        ...
        {
            move_btn_enable();
            textBox1.Text += "무언가 호수에서 나와 다리 저편에 올라탄다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "가까이 다가서니 그것은 천천히 일어선다.\r\n";
            this.Refresh();
            Thread.Sleep(2000);
            textBox1.Text += "그것은 두 다리로 선 악어다!\r\n";
        ...
        public C_2_2(ref character character)
        {
        ...
        {
            /*
            C_2_2_0 form = new C_2_2_0(ref ch);
            this.Hide();
            form.ShowDialog();
