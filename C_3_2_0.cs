...
{
    public partial class C_3_2_0 : Form
    {
        public C_3_2_0()
        {
            InitializeComponent();
        ...
        private void C_3_2_0_Load(object sender, EventArgs e)
        {
        ...
        public C_3_2_0(ref character character)
        {
            ch = character;
            InitializeComponent();
            setting(character);
        ...
        private void _1_test_Load(object sender, EventArgs e)
        {
            ...
            //@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("당신은 사원의 기도실로 들어왔다. \r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@@한줄 대사@@@@@@@@@@@@@@@@@@@@@@
            textBox1.AppendText("???: 당신은 이곳에 출입할 수 없습니다. \r\n");
            this.Refresh();
            Delay(2000);
            //@@@@@@@@@@@@@@@@@@@@몬스터 등장@@@@@@@@@@@@@@@@@@
            monster = new Temple_Knight();
            monster.name = "사원의 보초1";
            fight = 1;
            setting(ch);
            picture_npc.Image = monster.img;
            textBox1.AppendText("사원의 보초1(이)가 나왔다! \r\n");
            //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        {
            C_3_2_1 form = new C_3_2_1(ref ch);
            this.Hide();
            form.ShowDialog();
        ...
        {
            C_3_2_2 form = new C_3_2_2(ref ch);
            this.Hide();
            form.ShowDialog();
